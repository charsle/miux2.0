<template>
	<div>
		<!--<p class="time"><span>1月25日</span></p>-->
		<div class="main">
			...
			<div class="fl maxWidth90">
				...
				<div class="msg_box msg_pic m{{itemList.MSG00101}}"  id="msg_box{{itemList.MSG00101}}">
					<a :href="itemList.MSG00109.url | getUrl" data-lightbox="miux-set"><img :src="itemList.MSG00109.thumbnailURL | getUrl" /></a><br/><br/>
				</div>

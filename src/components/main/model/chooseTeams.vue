	...
	<div class="col-sm-12 relative">
		...
		<div class="col-sm-8">
			...
			<div class="col-sm-6 grey_border left0 choose_item">
				<h5 class="choose_h5">人员列表<a href="javascript:;" class="light-blue fr" @click="chooseAllPer">全选</a></h5>
				<div class="col-xs-12 p10 fs12" v-for="item in departmentPerson | filterBy joinsearch 'TM00306'" v-if="item.TM00301!=myuserID" @click="choosePersonItem(item,$index)">
					<div class="col-xs-2">
